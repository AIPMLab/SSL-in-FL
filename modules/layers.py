...
class DecomposedConv(tf.keras.layers.Conv2D):
    ...
    def __init__(self,
        ...
        # Initialize padding_op based on the padding argument
        self._padding_op = 'SAME' if padding == 'same' else 'VALID'
        # Initialize conv_op_data_format based on data_format
        self._conv_op_data_format = 'NHWC' if data_format is None or data_format == 'channels_last' else 'NCHW'
