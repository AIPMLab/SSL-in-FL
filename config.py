def set_config(args):
    ...
    args.dataset_path = 'C:\\Users\\DELL\Desktop\FedMatch-main (2)\FedMatch-main1\data'  # for datasets
    args.output_path = 'C:\\Users\\DELL\Desktop\FedMatch-main (2)\FedMatch-main1\outputs'  # for logs, weights, etc.
    
    args.archi = 'resnet9'
    args.dataset_id_to_name = {0: 'cifar_10', 1: 'stl_10', 2: 'fashion_mnist'}
    ...
    elif 'fashion_mnist' in args.task:
        args.dataset_id = 2
        args.num_classes = 10
        args.num_test = 2000
        args.num_valid = 2000
